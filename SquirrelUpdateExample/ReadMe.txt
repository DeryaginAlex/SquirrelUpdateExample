...
<Target Name="AfterBuild">
    ...
    <Exec Condition=" '$(Configuration)' == 'Release'" Command="@(SquirrelTools->'%(FullPath)') --releasify $(SolutionDir)Deployment\GeneratedNugets\@(ID).$(Version).nupkg --releaseDir=$(SolutionDir)Deployment\Releases\$(Version)\" />
 </Target>
...
Текущая версия берётся из AssemblyInfo.cs
